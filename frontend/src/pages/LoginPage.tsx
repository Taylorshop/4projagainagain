...
const GOOGLE_ERRORS: Record<string, string> = {
  google_not_linked: 'Ce compte Google n\'est pas encore connecté à un compte SUPFile. Connectez-vous avec votre email et mot de passe, puis liez Google depuis les Paramètres.',
  google_auth_failed: 'Authentification Google échouée. Veuillez réessayer.',
};
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <a
          ...
          className="flex items-center justify-center gap-3 w-full border border-gray-300 rounded-lg py-2 hover:bg-gray-50 transition text-sm font-medium text-gray-700"
        >
